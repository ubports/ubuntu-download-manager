...
TestDownloadsDb::testStoreSingleDownload() {
    ...
    QScopedPointer<FakeDownload> download(new FakeDownload(id, appId,
        path, false, "", url, hash, hashAlgoString, metadata, headers));
...
TestDownloadsDb::testStoreSingleDownloadPresent() {
    ...
    QScopedPointer<FakeDownload> download(new FakeDownload(id, appId, path,
    ...
    QScopedPointer<FakeDownload> secondDownload(new FakeDownload(id, appId, newPath, 
        true, "", url, hash, hashAlgoString, metadata, headers));
