...
void
TestXDGBasedir::testDefault(QString envVar,
...
void
TestXDGBasedir::testUserSet(QString envVar,
...
void
TestXDGBasedir::testCollectionDefault(QString envVar,
...
void
TestXDGBasedir::testCollectionEnv(QString envVar,
                                  std::function<QList<QString>()> cb,
...
void
TestXDGBasedir::testConfigDirsDefault() {
    QString envVar = "XDG_CONFIG_DIRS";
    std::function<QList<QString>()> cb = []() {
        return XDGBasedir::configDirs();
    };
...
void
TestXDGBasedir::testDataDirsDefault() {
    QString envVar = "XDG_DATA_DIRS";
    std::function<QList<QString>()> cb = []() {
        return XDGBasedir::dataDirs();
    };
...
void
TestXDGBasedir::testDataDirsEnv() {
    QString envVar = "XDG_DATA_DIRS";
    std::function<QList<QString>()> cb = []() {
        return XDGBasedir::dataDirs();
    };
