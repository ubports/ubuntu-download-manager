...
TestDownloadManagerWatch::init() {
    ...
    _calledError = false;
    _manager = udm::Manager::createSessionManager(daemonPath(), this);
}
...
TestDownloadManagerWatch::testCallbackIsExecuted() {
    ...
    udm::DownloadStruct down(url, metadata, headers);

    udm::DownloadCb cb = std::bind(&TestDownloadManagerWatch::onSuccessCb,
        this, std::placeholders::_1);
    udm::DownloadCb errCb = std::bind(&TestDownloadManagerWatch::onErrorCb,
        this, std::placeholders::_1);
