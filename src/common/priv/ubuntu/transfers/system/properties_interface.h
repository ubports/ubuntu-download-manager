...
#ifndef PROPERTIES_INTERFACE_H_1416499105
#define PROPERTIES_INTERFACE_H_1416499105
 ...
 */
class FreefreedesktopProperties: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    FreefreedesktopProperties(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);

    ~FreefreedesktopProperties();
...
namespace org {
  namespace freedesktop {
    namespace DBus {
      typedef ::FreefreedesktopProperties Properties;
    }
  }
}
#endif
