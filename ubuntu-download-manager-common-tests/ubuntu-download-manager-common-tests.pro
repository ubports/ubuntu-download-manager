...
check.commands = LD_LIBRARY_PATH=$$OUT_PWD/../udm-priv-common:$$OUT_PWD/../udm-common:$$OUT_PWD/../udm-testing:$$OUT_PWD/../ubuntu-download-manager-common:$$OUT_PWD/../ubuntu-download-manager-test-lib:$$OUT_PWD/../ubuntu-download-manager-priv ./$${TARGET}
